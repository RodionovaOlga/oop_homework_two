with open(r'C:\Users\Ольга\OneDrive\Рабочий стол\homework_two\1.txt','r', encoding='utf-8') as file_1:
    sum_1 = {}
    counting_1 = 0
...
#print(sum_1)
with open(r'C:\Users\Ольга\OneDrive\Рабочий стол\homework_two\2.txt', 'r') as file_2:
    sum_2 = {}
    counting_2 = 0
...
# print(sum_2)
with open (r'C:\Users\Ольга\OneDrive\Рабочий стол\homework_two\3.txt', 'r') as file_3:
    sum_3 = {}
    counting_3 = 0
